...
// Assignment Code with all the variables.
...
function determineLength(){
  passwordLength = prompt("Choose how long you'd like your password to be (between 8-128 characters): ");
    ...
    alert("The next 3 screens will ask you what types of characters you would like to be included in your password.\nIf you choose 'No' for all, your password will only contain lowercase letters.");
    }
...
function determineSpecial(){
 ...
 //Function used to take all the input from the previous functions and generate a password using a random number generator and the charAt method 
...
// Add event listener to make button work
